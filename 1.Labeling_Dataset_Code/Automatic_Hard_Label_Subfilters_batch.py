...
def loading_paths_from_MAT(folder, subfolder, Pri_path_file_name, Sec_path_file_name):
    ...
    # โหลดไฟล์ .mat
    Pri_dfs = sio.loadmat('My_Primary_Path_Sweep.mat')
    Secon_dfs = sio.loadmat('My_Secondary_Path_Sweep.mat')
...
class Automatic_label():
    ...
    def __init__(self, sufix, folder_path, path_mat, Index_file, threshold, **kwargs):
        ...
        self.Pri_path, self.Sec_path = loading_paths_from_MAT(
            folder='', subfolder='', 
            Pri_path_file_name='My_Primary_Path_Sweep.mat', 
            Sec_path_file_name='My_Secondary_Path_Sweep.mat'
        )
